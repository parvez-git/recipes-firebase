<template>
    ...
    <div v-else class="flex flex-row">
        ...
        <div class="flex flex-1 flex-row flex-wrap items-center justify-center gap-2 w-full h-full">
            <div v-for="item in items" :key="item.id"
                class="w-32 h-32 bg-slate-50 rounded-full overflow-hidden hover:drop-shadow-2xl cursor-pointer">
